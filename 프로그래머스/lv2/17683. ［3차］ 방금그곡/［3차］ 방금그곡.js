function parseMelody(melody) {
  ...
  return melody.replace(/C#|D#|F#|G#|A#|E#|C|D|E|F|G|A|B/g, (match) => melodyMap[match]);
}
...
function solution(m, musicinfos) {
  ...
  musicinfos.forEach((musicinfo) => {
    ...
    const repeatedFullMelody = fullMelody.repeat(Math.ceil(playTime / fullMelody.length));
